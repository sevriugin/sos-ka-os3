    ...
    function (Base64, $http, $cookieStore, $rootScope, $timeout) {
        ...
        service.Login = function (username, password, callback) {
            ...
            /* Use this for real authentication
             ----------------------------------------------*/
            $http.post('/api/authenticate', { username: username, password: password, authdata : authdata })
        ...
        service.Registration = function (firstname, lastname, username, password, callback) {
            ...
            /* Use this for real authentication
             ----------------------------------------------*/
            $http.post('/api/registration', { firstname: firstname, lastname: lastname, username: username, password: password, authdata : authdata })
            	.then(function (response) {
            			callback(response); }, 
            		  function (response) {
            			callback(response);
